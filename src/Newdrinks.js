            ...
            <section>
                <div className="container">
                    ...
                    {/* botstrap navs and tabs */}
                        <div class="container">
                            <ul class="nav-tabs nav menu-headings ">
                      ...
                      {data.items.map((food) => (
                        <>
                          <div className="col-10 mb-3 d-inline-flex align-items-center">
                            ...
                            <h5 className="mb-0 text-capitalize food-menu-item">{food.name}</h5>
                          </div>
                                    ...
                                    <div className="accordion">
            {
                ...
                >
                    ...
                    <img
                        ...
                        className="img-fluid menu-img rounded me-3"
                    />
                    <h4 className="mb-0 category-heads">{drink.category}</h4>
                    </div>
                </button>
                </h2>
                <div  id={"panelsStayOpen-collapse" + drink.c_id}
                className="accordion-collapse collapse"
                aria-labelledby="panelsStayOpen-headingOne">
                <div className="accordion-body">
                    <div className="row align-items-center">
                        {drink.items.map((obj)=>(
                            <>
                            <div className="col-10 mb-3 d-inline-flex align-items-center">
                            <h5 className="mb-0 text-capitalize food-menu-item">{obj.name}</h5>
                            <h6 className="mb-0 text-capitalize food-menu-subitem">{obj.name_s}</h6>
                            </div>
                            <div className={`col-2 mb-3 ${obj.p_large.length < 7 ? 'text-nowrap' : ''} drink-price` }>
